...
<ol class="table">
  ...
  <a href="/member/registerMaster">동의</a>
  <a href="/">비동의</a>
...
<h3>제1조 (목적)</h3>
<p>본 약관은 탕탕탕 주식회사(이하 회사)가 인터넷 사이트를 통하여 제공하는 거래 서비스 등 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
<h3>제2조 (정의)</h3>
<p>본 약관에서 사용하는 용어의 정의는 다음과 같습니다.</p>
<ol>
  <li>서비스 : 회원이 온라인 홈페이지를 통하여 본 약관에 따라 이용할 수 있는 회사가 제공하는 모든 서비스를 의미합니다.</li>
  <li>홈페이지 : 본 약관에 따라 회사가 제공하는 서비스가 구현되는 온라인상의 웹페이지를 말합니다.</li>
...
<h3>제1조 (시행일)</h3>
<ol>
  <li>본 약관은 2022년 4월 20일부터 적용됩니다.</li>
</ol>
