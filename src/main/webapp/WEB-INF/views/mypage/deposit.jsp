...
<section class="p_sec">
    <div class="point_title">
        ...
        <a class="point_title_font">탕탕탕포인트 충전소</a>
    </div>

    <div class="point_left">
        <div class="point_left_wrap">
            <div class="point_margin">
                <label class="point_list_id">ID</label> <a class="point_id">${sessionScope.id}</a><br>
            </div>
            <div class="point_margin">
                <label class="point_list">탕탕탕POINT</label> <a class="point"> </a>P
            </div>
            <div class="point_list_content">
                탕탕탕 POINT로 경매장의 경매에<br>
                땅땅 POINT 충전은 로그인이 되어있어야<br>
                합니다.<br><br>
                POINT 충전은 네이버페이만 가능합니다<br><br>
                POINT 충전시 전산상의 문제로 POINT 지급까지<br>
                5분 정도 소요될 수 있습니다. 이후에도 <br>
                문제가 지속된다면 관리자 이메일로 문의시<br>
                빠른 처리를 도와드리겠습니다.<br>
